...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <div class="mx-auto rounded p-5 mt-5" style="width: 500px; background-color: white;">

        <div id="judul-form" class="text-center h1 mt-1">LOGIN</div>

        <h6 class="card-subtitle test-mute mb-5 fw-bold">Please login to this apps!</h6>

            <!-- Tab Login & Register -->

            <div class="d-flex justify-content-between">

                <button id="tab-login" class="btn btn-warning fw-bold" style="width: 190px;">LOGIN</button>

                <button class="btn btn-outline-warning fw-bold" style="width: 190px;">REGISTER</button>
